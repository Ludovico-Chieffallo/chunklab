...
_STOPWORDS: dict[str, set[str]] = {
    "en": {
        ...
        "are", "be", "this", "on", "by", "from", "or", "an", "at", "not", "which",
        "have", "has", "was", "were", "will", "any", "all", "each",
    },
    "it": {
        "il", "lo", "la", "gli", "le", "di", "che", "per", "un", "una", "non",
        "con", "del", "della", "sono", "alla", "nel", "come", "più", "anche",
        "quando", "dal", "se", "ma", "si", "delle", "dei", "essere", "viene",
    },
    "es": {
        "el", "la", "los", "las", "de", "que", "en", "un", "una", "por", "con",
        "para", "del", "se", "no", "es", "son", "como", "más", "pero", "su",
        "al", "lo", "sus", "este", "esta",
    },
    "fr": {
        "le", "la", "les", "de", "des", "et", "un", "une", "dans", "pour", "que",
        "est", "en", "du", "au", "aux", "sur", "par", "ne", "pas", "plus", "ce",
        "cette", "sont", "qui", "ou",
    },
    "de": {
        "der", "die", "das", "und", "den", "von", "zu", "mit", "ist", "im",
        "für", "ein", "eine", "nicht", "auch", "auf", "dem", "des", "sich",
        "werden", "sind", "als", "es", "bei", "oder",
    },
    "pt": {
        "os", "as", "de", "que", "do", "da", "em", "um", "uma", "para", "com",
        "não", "se", "por", "no", "na", "dos", "mais", "como", "são", "pelo",
        "sua", "seu", "das",
    },
    "nl": {
        "de", "het", "een", "van", "en", "in", "is", "dat", "op", "te", "met",
        "voor", "zijn", "aan", "niet", "door", "ook", "als", "bij", "om", "worden",
    },
}
...
def detect_language(text: str, min_words: int = 40) -> str | None:
    ...
    scores = {
        lang: sum(1 for w in words if w in vocab) / len(words)
